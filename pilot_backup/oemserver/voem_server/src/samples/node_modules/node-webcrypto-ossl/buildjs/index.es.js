...
import { OperationError, CryptoKey as CryptoKey$1, BufferSourceConverter, AesCbcProvider as AesCbcProvider$1, AesCmacProvider as AesCmacProvider$1, AesCtrProvider as AesCtrProvider$1, AesGcmProvider as AesGcmProvider$1, AesKwProvider as AesKwProvider$1, AesEcbProvider as AesEcbProvider$1, DesProvider, CryptoError, EcdsaProvider as EcdsaProvider$1, EcdhProvider as EcdhProvider$1, HmacProvider as HmacProvider$1, Pbkdf2Provider as Pbkdf2Provider$1, RsaSsaProvider as RsaSsaProvider$1, RsaPssProvider as RsaPssProvider$1, RsaOaepProvider as RsaOaepProvider$1, AlgorithmError, ProviderCrypto, SubtleCrypto as SubtleCrypto$1, Crypto as Crypto$1 } from 'webcrypto-core';
...
import { AesKey, Key, KeyType, EcNamedCurves, HmacKey, Pbkdf2Key, Core } from '../build/Release/nodessl.node';
...
class CryptoKeyStorage {
    ...
    getItem(index, algorithm, extractable, keyUsages) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!fileKey) {
                throw new OperationError("Cannot get key form file");
            }
    ...
    keys() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            items.forEach((item) => {
                if (item !== "." && item !== "..") {
                    const file = join(this.directory, item);
                    const stat = statSync(file);
                    if (stat.isFile()) {
                        const key = this.readFile(file);
                        if (key) {
                            res.push(parse(item).name);
                        }
                    }
                }
            });
    ...
    writeFile(name, key) {
        ...
        writeFileSync(this.getFilePath(name), json, {
            encoding: "utf8",
            flag: "w",
        });
    }
    getFilePath(name) {
        return join(this.directory, `${name}${FILE_EXT}`);
    }
}
...
class AesCrypto {
    static generateKey(algorithm, extractable, keyUsages) {
        return new Promise((resolve, reject) => {
            AesKey.generate(algorithm.length / 8, (err, key) => {
                if (err) {
                    reject(err);
                }
                else {
                ...
                case "raw":
                    nativeKey.export((err, data) => {
                        if (err) {
                            ...
                            resolve(BufferSourceConverter.toArrayBuffer(data));
                        }
                    });
                    break;
                default:
    ...
    static importKey(format, keyData, algorithm, extractable, keyUsages) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                AesKey.import(Buffer.from(raw), (err, key) => {
                    if (err) {
                        reject(err);
                    }
                    else {
    ...
    static checkCryptoKey(key) {
        if (!(CryptoKeyStorage$1.getItem(key) instanceof AesCryptoKey)) {
...
class AesCbcProvider extends AesCbcProvider$1 {
    onGenerateKey(algorithm, extractable, keyUsages) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return CryptoKeyStorage$1.setItem(key);
        });
    }
    ...
    onExportKey(format, key) {
        return __awaiter(this, void 0, void 0, function* () {
            return AesCrypto.exportKey(format, CryptoKeyStorage$1.getItem(key));
        });
    }
    onImportKey(format, keyData, algorithm, extractable, keyUsages) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return CryptoKeyStorage$1.setItem(res);
        });
    }
    ...
    internalEncrypt(algorithm, key, data, encrypt) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                const aesKey = CryptoKeyStorage$1.getItem(key).native;
                const iv = Buffer.from(BufferSourceConverter.toArrayBuffer(algorithm.iv));
                const func = encrypt
                ...
                func("CBC", iv, buf, (err, data2) => {
                    if (err) {
                        ...
                        resolve(BufferSourceConverter.toArrayBuffer(data2.buffer));
                    }
                });
            });
        });
...
class AesCtrProvider extends AesCtrProvider$1 {
    ...
    internalEncrypt(algorithm, key, data, encrypt) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                const aesKey = CryptoKeyStorage$1.getItem(key).native;
                const counter = Buffer.from(BufferSourceConverter.toArrayBuffer(algorithm.counter));
                const func = encrypt
            ...
            return new Promise((resolve, reject) => {
                ...
                func(Buffer.from(data), (err, data2) => {
                    if (err) {
                        ...
                        resolve(BufferSourceConverter.toArrayBuffer(data2));
                    }
                });
            });
        });
...
class DesCrypto {
    static generateKey(algorithm, extractable, keyUsages) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            key.native = randomBytes(algorithm.length >> 3);
            return key;
        });
    }
    static exportKey(format, key) {
        return __awaiter(this, void 0, void 0, function* () {
            const desKey = CryptoKeyStorage$1.getItem(key);
    ...
    static internalEncrypt(algorithm, key, data, encrypt) {
        return __awaiter(this, void 0, void 0, function* () {
            const func = encrypt
                ? createCipheriv
                : createDecipheriv;
            const decipher = func.call(crypto, algorithm.name.toLowerCase(), key.native, BufferSourceConverter.toUint8Array(algorithm.iv));
...
class DesCbcProvider extends DesProvider {
    ...
    checkCryptoKey(key, keyUsage) {
        super.checkCryptoKey(key, keyUsage);
        if (!(CryptoKeyStorage$1.getItem(key) instanceof DesCryptoKey)) {
...
class EcCrypto {
    static generateKey(algorithm, extractable, keyUsages) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                Key.generateEc(namedCurve, (err, key) => {
                    if (err) {
                        reject(err);
                    }
                    else {
                        ...
                        resolve({
                            privateKey: CryptoKeyStorage$1.setItem(privateKey),
                            publicKey: CryptoKeyStorage$1.setItem(publicKey),
                        });
                    }
                });
            });
    ...
    static exportKey(format, key) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                const nativeKey = CryptoKeyStorage$1.getItem(key).native;
                const type = key.type === "public" ? KeyType.PUBLIC : KeyType.PRIVATE;
                switch (format.toLocaleLowerCase()) {
                    case "jwk":
                        nativeKey.exportJwk(type, (err, data) => {
                            if (err) {
                                throw new CryptoError(`Cannot export JWK key\n${err}`);
                            }
                            try {
                    ...
                    case "spki":
                        nativeKey.exportSpki((err, raw) => {
                            if (err) {
                                ...
                                resolve(BufferSourceConverter.toArrayBuffer(raw));
                            }
                        });
                        break;
                    case "pkcs8":
                    ...
                    case "raw":
                        nativeKey.exportJwk(type, (err, data) => {
                            if (err) {
                                ...
                                resolve(BufferSourceConverter.toArrayBuffer(rawKey));
                            }
                        });
                        break;
                    default:
                        throw new CryptoError(`ExportKey: Unknown export format '${format}'`);
                }
            });
        });
    }
            ...
            return new Promise((resolve, reject) => {
                ...
                switch (formatLC) {
                    case "raw": {
                        ...
                        Key.importJwk(data, keyType, (err, key) => {
                            try {
                                if (err) {
                                    reject(new CryptoError(`ImportKey: Cannot import key from JWK\n${err}`));
                                }
                                else {
                                    const ecKey = EcPublicKey.create(algorithm, "public", extractable, keyUsages);
                                    ecKey.native = key;
                                    resolve(CryptoKeyStorage$1.setItem(ecKey));
                                }
                            }
                            catch (e) {
                                reject(e);
                    ...
                    case "pkcs8":
                    case "spki": {
                        let importFunction = Key.importPkcs8;
                        if (formatLC === "spki") {
                            importFunction = Key.importSpki;
                        }
                        const rawData = Buffer.from(keyData);
                        importFunction(rawData, (err, key) => {
                            try {
                                if (err) {
                                    reject(new CryptoError(`ImportKey: Can not import key for ${format}\n${err.message}`));
                                }
                                else {
                    ...
                    default:
                        throw new CryptoError(`ImportKey: Wrong format value '${format}'`);
                }
            });
        });
    }
    ...
    static getNamedCurve(namedCurve) {
        switch (namedCurve.toUpperCase()) {
            ...
            case "K-256":
                ...
                break;
            default:
                throw new CryptoError("Unsupported namedCurve in use");
        }
        return EcNamedCurves[namedCurve];
    }
}
...
class EcdsaProvider extends EcdsaProvider$1 {
    ...
    onSign(algorithm, key, data) {
        return new Promise((resolve, reject) => {
            ...
            nativeKey.sign(alg, Buffer.from(data), (err, signature) => {
                if (err) {
                    reject(new CryptoError(`NativeError: ${err.message}`));
                }
                else {
                    resolve(BufferSourceConverter.toArrayBuffer(signature));
                }
            });
        });
    }
    ...
    checkCryptoKey(key, keyUsage) {
        super.checkCryptoKey(key, keyUsage);
        EcCrypto.checkCryptoKey(CryptoKeyStorage$1.getItem(key));
    }
...
class EcdhProvider extends EcdhProvider$1 {
    ...
    onDeriveBits(algorithm, baseKey, length) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                const nativeKey = CryptoKeyStorage$1.getItem(baseKey).native;
                const publicKey = CryptoKeyStorage$1.getItem(algorithm.public).native;
...
class HmacProvider extends HmacProvider$1 {
    onGenerateKey(algorithm, extractable, keyUsages) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                HmacKey.generate(length, (err, key) => {
                    if (err) {
                        reject(err);
                    }
                    else {
                        ...
                        hmacKey.native = key;
                        resolve(CryptoKeyStorage$1.setItem(hmacKey));
                    }
                });
            });
        });
    ...
    onSign(algorithm, key, data) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                const hmacKey = CryptoKeyStorage$1.getItem(key);
    ...
    onImportKey(format, keyData, algorithm, extractable, keyUsages) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                HmacKey.import(Buffer.from(raw), (err, key) => {
                    if (err) {
                        reject(err);
                    }
                    else {
            ...
            return new Promise((resolve, reject) => {
                ...
                switch (format.toLocaleLowerCase()) {
                    ...
                    case "raw":
                        ...
                        break;
                    default: throw new CryptoError(`ExportKey: Unknown export format '${format}'`);
                }
            });
        });
    }
    checkCryptoKey(key, keyUsage) {
        super.checkCryptoKey(key, keyUsage);
        if (!(CryptoKeyStorage$1.getItem(key) instanceof HmacCryptoKey)) {
...
class Pbkdf2Provider extends Pbkdf2Provider$1 {
    ...
    onDeriveBits(algorithm, baseKey, length) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                const salt = Buffer.from(BufferSourceConverter.toArrayBuffer(algorithm.salt));
    ...
    onImportKey(format, keyData, algorithm, extractable, keyUsages) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                Pbkdf2Key.importKey(Buffer.from(raw), (err, key) => {
                    if (err) {
                        reject(err);
                    }
                    else {
                        ...
                        resolve(CryptoKeyStorage$1.setItem(pbkdf2Key));
                    }
                });
            });
        });
    ...
    checkCryptoKey(key, keyUsage) {
        super.checkCryptoKey(key, keyUsage);
        if (!(CryptoKeyStorage$1.getItem(key) instanceof PbkdfCryptoKey)) {
    ...
    static generateKey(algorithm, extractable, keyUsages) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                ...
                Key.generateRsa(size, nExp, (err, key) => {
                    try {
                        if (err) {
                            reject(new CryptoError(`Rsa: Can not generate new key\n${err.message}`));
                        }
                        else {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                switch (formatLC) {
                    ...
                    case "pkcs8":
                    case "spki":
                        let importFunction = Key.importSpki;
                        if (formatLC === "pkcs8") {
                            keyType = KeyType.PRIVATE;
                            importFunction = Key.importPkcs8;
                        }
                ...
                rsaKey.native = key;
                return CryptoKeyStorage$1.setItem(rsaKey);
            });
        });
    }
    static checkCryptoKey(key) {
...
class RsaSsaProvider extends RsaSsaProvider$1 {
    ...
    onSign(algorithm, key, data) {
        return new Promise((resolve, reject) => {
            const rsaKey = CryptoKeyStorage$1.getItem(key);
    ...
    checkCryptoKey(key, keyUsage) {
        super.checkCryptoKey(key, keyUsage);
        RsaCrypto.checkCryptoKey(CryptoKeyStorage$1.getItem(key));
    }
    getOsslAlgorithm(algorithm) {
        const alg = algorithm.hash.name.toUpperCase().replace("-", "");
        return alg;
...
class RsaOaepProvider extends RsaOaepProvider$1 {
    ...
    internalEncrypt(algorithm, key, data, encrypt) {
        return new Promise((resolve, reject) => {
            ...
            let label = null;
            if (algorithm.label) {
                label = Buffer.from(BufferSourceConverter.toArrayBuffer(algorithm.label));
            }
            nativeKey.RsaOaepEncDec(alg, data, label, !encrypt, (err, res) => {
                if (err) {
                    reject(new CryptoError("NativeError: " + err));
                }
                else {
                    resolve(BufferSourceConverter.toArrayBuffer(res));
                }
            });
        });
    }
    ...
    static digest(algorithm, data) {
        return new Promise((resolve, reject) => {
            ...
            switch (algName) {
                ...
                case "sha-384":
                case "sha-512":
                    Core.digest(algName.replace("-", ""), Buffer.from(data), (err, digest) => {
                        if (err) {
                            reject(err);
                        }
                        else {
                    ...
                    break;
                default:
                    throw new AlgorithmError("Unsupported algorithm");
            }
        });
    }
}
    ...
    getRandomValues(array) {
        if (ArrayBuffer.isView(array)) {
            if (array.byteLength > 65536) {
                throw new OperationError(`Failed to execute 'getRandomValues' on 'Crypto': The ArrayBufferView's byte length (${array.byteLength}) exceeds the number of bytes of entropy available via this API (65536).`);
            }
            ...
            throw new OperationError(`Failed to execute 'getRandomValues' on 'Crypto': Expected ArrayBufferView for 'array' argument.`);
        }
    }
}
